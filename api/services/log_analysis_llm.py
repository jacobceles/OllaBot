...
def summarize_errors(logs: str, is_local: bool) -> str:
    ...
    llm = Ollama(model=llm_model, base_url=base_url,request_timeout=600.0)
    Settings.embed_model = OllamaEmbedding(model_name=embedding_model, request_timeout=600.0)
